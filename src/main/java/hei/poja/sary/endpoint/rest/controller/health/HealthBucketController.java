package hei.poja.sary.endpoint.rest.controller.health;

import static hei.poja.sary.file.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import hei.poja.sary.PojaGenerated;
import hei.poja.sary.file.BucketComponent;
import hei.poja.sary.file.FileHash;
import java.io.File;
